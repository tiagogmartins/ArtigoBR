...
# base
base <- ts(read_excel("base2000IAE2.xlsx")[,-1], start = c(2000,1), freq = 12)
legenda <- data.frame(read_excel("base2000IAE2.xlsx", sheet = 2)  )
...
#saveRDS(nowpastSM10,"nowpastSM10IAE2.rds")


nowpastSM10 <- readRDS("nowpastSM10IAE2.rds")
out <- nowpastSM10
